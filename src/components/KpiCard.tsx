...
export default function KpiCard({ label, value, delta, positive = true, loading = false }: Props) {
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 h-[104px]">
